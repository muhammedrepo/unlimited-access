...
const PaymentInvoice = ({ openInvoiceModal }) => {
  return (
    <>
      <div className="modal overflow-x-hidden overflow-y-auto h-modal md:h-full">
        <div classNameName="relative w-full h-full md:h-auto">
          {/* Modal content  */}
              ...
              <div className="row">
                <div className="flex-1 text-center text-sm">
                  ...
                  <p className="text-skin-muted font-medium my-4">
                    ...
                    fraudulent activity such as fake referrals, spam clicks,
                    bogus or duplicate social post submissions or Deleting a
                    social post after submitting it. Read More:{" "}
                    <a
                  ...
                  <p className="font-medium text-skin-muted my-4">
                    ...
                    scheduled date, please contact us using the live chat
                    section in{" "}
                    <a
                  ...
                  <p className="font-medium">
                    ...
                    verify your stats, you can earn even more. It's time to
                    climb up the Leaderboard and be a Top Earner.
                  </p>
                  <p className="text-skin-muted">
                    Top earners get featured on our leaderboard section.{" "}
                    <span className="font-bold">
                      Top members also get their payments within 5-10 minutes,
                      as there stats have been VERIFIED by our team. Being
                      verified means you are eligible to request Instant Money.
                    </span>
                  </p>
                </div>
              </div>
